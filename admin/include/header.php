...
<head>
  ...
  <link href="assets/datatables_1.10.8/dataTables.bootstrap.css" rel="stylesheet" type="text/css" />
          ...
          <li class="dropdown">
            <a data-toggle="dropdown" class="dropdown-toggle" href="#">
                            <span class="profile-ava">
                                <img alt="" src="<?php echo PROFILE_UPLOAD . $row['profile']; ?>" height="50" width="50">
                            </span>
